...
public class BalloonOverlayView<Item extends OverlayItem> extends FrameLayout
{
	...
	public BalloonOverlayView(Context context, int balloonBottomOffset)
	{
		...
		m_layout = new LimitLinearLayout(context);
		m_layout.setVisibility(VISIBLE);

		setupView(context, m_layout);
	...
	protected void setupView(Context context, final ViewGroup parent)
	{
		...
		m_title = (TextView) v.findViewById(R.id.balloon_item_title);
		m_snippet = (TextView) v.findViewById(R.id.balloon_item_snippet);
	}
	...
	protected void setBalloonData(Item item, ViewGroup parent)
	{
		...
		if (item.getSnippet() != null)
		{
			...
			m_snippet.setText(item.getSnippet());
		}
		else
		{
			m_snippet.setText("");
